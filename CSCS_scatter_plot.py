...
axes[0].scatter(df_gpt_cscs["log10(grammaticality)"], df_gpt_cscs["log10(semantic_change)"], color='orange', alpha=ALPHA, s=S, label='ProtGPT2')
...
axes[1].scatter(df_gpt_cscs["log10(1/perplexity)"], df_gpt_cscs["log10(semantic_change)"], color='orange', alpha=ALPHA, s=S, label='ProtGPT2')
...
fig_file_name = f"outputs/cscs_scatter_CP{CHECKPOINT}_{DISTANCE}.pdf"
