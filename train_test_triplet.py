...
parser.add_argument('--loss_name', type=str, default="TripletLoss", help='Loss function name')
...
parser.add_argument('--gstats', type=str, default="global_stats_triplet.csv", help='CSV file path')
